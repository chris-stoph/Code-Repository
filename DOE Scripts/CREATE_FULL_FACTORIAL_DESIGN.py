...
def get_user_input():
    ...
    for i in range(num_factors):
        ...
        high_levels.append(int(high_level_str))
        ...
        low_levels.append(int(low_level_str))
...
def main():
    try:
        ...
        with pd.ExcelWriter(excel_file_path) as writer:
            # Write DataFrame to sheet named 'Worksheet'
            merged_df.to_excel(writer, sheet_name='Worksheet', index=False)
            
            # Add header/footer to the sheet
            worksheet = writer.sheets['Worksheet']  # Change 'Data' to 'Worksheet'
            worksheet.set_header('FULL FACTORIAL DESIGN.py')
